...
public class Employee {
	...
	public Employee(int emp_id, String emp_name, String emp_pass, int leaves, int duty, int salary) {
		super();
		this.emp_id = emp_id;
		this.emp_name = emp_name;
		this.emp_pass = emp_pass;
	...
	public Employee(int emp_id, String emp_name, String emp_pass, int leaves, int duty, int reqLeave, int reqDuty, int salary) {
		super();
		this.emp_id = emp_id;
		this.emp_name = emp_name;
		this.emp_pass = emp_pass;
